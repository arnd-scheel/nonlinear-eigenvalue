...
tic
[A_ref0,Ap_ref,Am_ref,p,n,k,N,x,dx,lam_start]=spatial_pencil_cvgce_initial; %loads example
...
name=['data_plotting/ac_lam_start_cvgce_initial_' num2str(lam_start) '_M_' num2str(M) '.mat'];
